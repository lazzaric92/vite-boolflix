...
import GenreCarousel from '../carousels/GenreCarousel.vue';
...
<template>
    ...
    <div class="row h-100">
        <TrendingCarousel trendingString="tv" minSlideNumber="5" maxSlideNumber="10" />
    </div>
    <GenreCarousel discoverString="tv" carouselTitle="Mistero" genreId="9648" class="mb-5"/>
